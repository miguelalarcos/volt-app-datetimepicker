...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'date-time-picker.com'
  config.app_name = 'Date_time_picker'
  config.mailer.from = 'Date_time_picker <no-reply@date-time-picker.com>'
  ...
  #
  config.app_secret = '7ty_OwfX1ztg9eViorew1ONZ-wFB3H38PJV-My_hcWM4uJwAzl9BMjJsvwr9ro-TSHM'
